...
namespace DAL
{
    public class BEST_SqlHelper_KM
    {
       ...
       // public static readonly string BESTconnStr = ConfigurationManager.ConnectionStrings["BESTconnStr"].ConnectionString;
        public static readonly string BESTconnStr = ConfigurationManager.ConnectionStrings["BESTconnStr_KM"].ConnectionString;
        ...
        public static DataTable ExcuteTable(string sqlstr, string conn_km)
        {

            using (SqlConnection conn = new SqlConnection(conn_km))
            {
                conn.Open();
                using (SqlCommand cmd = conn.CreateCommand())
                {
